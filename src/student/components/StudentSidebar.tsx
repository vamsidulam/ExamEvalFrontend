...
const StudentSidebar: React.FC<StudentSidebarProps> = ({ 
  ...
  const navigation = [
    ...
    { name: 'Quiz', tab: 'quizzes', icon: ClipboardList },
    { name: 'Reports', tab: 'reports', icon: BarChart3 },
    { name: 'Timetable', tab: 'timetable', icon: Calendar },
  ...
  return (
    <>
      ...
      {/* Futuristic Glassmorphic Student Sidebar */}
      <div
        ...
        <div className={`flex items-center justify-between h-16 border-b border-white/20 transition-all duration-500 ${
          ...
          <div className={`flex items-center transition-all duration-500 ${
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-green-500/20 to-emerald-600/20 rounded-xl blur-lg group-hover:blur-xl transition-all duration-300"></div>
              <Book className="relative h-8 w-8 text-green-600 group-hover:scale-110 transition-all duration-500" 
                style={{
            ...
            {navigation.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`group flex items-center text-sm font-medium transition-all duration-300 relative overflow-hidden w-full ${
                ...
                >
                  ...
                  <item.icon
                    className={`h-5 w-5 transition-all duration-300 ${
                      ...
                      isActive 
                        ? 'text-green-600' 
                        : 'text-gray-400 group-hover:text-green-500 group-hover:scale-110'
                    }`}
                  />
                  {!isCollapsed && (
          ...
          <div className={`border-t border-white/20 transition-all duration-500 ${
            ...
            {isCollapsed ? (
              ...
              <div className="flex flex-col items-center space-y-3">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-green-500/30 to-emerald-600/30 rounded-full blur-md group-hover:blur-lg transition-all duration-300"></div>
                  <div className="relative w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg">
              ...
              >
                <div className="flex items-center space-x-3 p-3 rounded-xl hover:bg-white/20 transition-all duration-300 group">
                  <div className="relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-green-500/30 to-emerald-600/30 rounded-full blur-md group-hover:blur-lg transition-all duration-300"></div>
                    <div className="relative w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-lg">
                      <User className="h-5 w-5 text-white" />
                    </div>
                  </div>
